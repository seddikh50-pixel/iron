  ...
  return (
    <div>
      ...
      <div ref={videoWrapper1} className=" h-screen w-full  ">
        <video ref={videoRef1} src="output2.mp4" className="h-full w-full object-cover"></video>

      </div>

      <div ref={videoWrapper2} className=" h-screen w-full  ">
        <video ref={videoRef2} src="output.mp4" className="h-full w-full object-cover"></video>
